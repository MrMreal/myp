          ...
          <aside className="w-full bg-white" aria-label="sidenavExample">
            <ul className="relative px-1">
              ...
              <li class="relative" id="sidenavSecEx2">
                <a
                  class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden  hover:text-blue-600 hover:bg-blue-50 text-gray-700 text-ellipsis whitespace-nowrap transition duration-300 ease-in-out cursor-pointer"
                ...
                >
                  <li class="relative">
                    <a
                      href="#"
                      class="flex items-center text-xs py-4 pr-12 pl-6 h-6 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out"
